...
| Tarea | Cuándo |
|---|---|
| Convertir los bugs históricos de Phase 6 (`KNOWN_LIMITATIONS.md`) en tests permanentes, incluido el SIGSEGV de `/<body.*>((.*\n?)*?)<\/body>/i` hallado en F0b (hoy como test que espera el crash corregido, marcado `skip` hasta F4b/F6a) | Junto con F0d |
